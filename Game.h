...
const int NUM_POKI = 151; //Total number of Pokemon in the game
/*Menu decisions for user*/
const int ATTACK = 1; 
const int SWAP = 2; 
const int FORFEIT = 3;
/*************************/
const int USR_WIN = 1; // Signal that the user won the game 
const int CPU_WIN = 2; // Signal that the cpu won the game 
